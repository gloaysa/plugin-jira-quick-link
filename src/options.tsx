            ...
            <div className="column is-12-mobile is-8-desktop is-offset-2-desktop">
              ...
              <div className="card article">
                <div className="card-content">
                  ...
                  <p>
                    <strong>Save your changes before setting the shortcut</strong>
                  </p>
                  <p>
                    To make this plugin even better, navigate to <a href="" onClick={openShortCutsInChrome}>Chrome
                    Shortcuts </a>
                    and add a custom keyboard shortcut to open it (I recommend <code>Cmd + Control + J on MacOS</code>).
                  </p>
